...
Line::Line(Point P1, Point P2, uint32_t rgb)
{
    this->P1.x = P1.x;
    this->P2.x = P2.x;
    this->P1.y = P1.y;
...
bool Line::intersect(Line line) {
    int o1 = orientation(this->getP1(), this->getP2(), line.getP1());
    int o2 = orientation(this->getP1(), this->getP2(), line.getP2());
    int o3 = orientation(line.getP1(), line.getP2(), this->getP1());
    int o4 = orientation(line.getP1(), line.getP2(), this->getP2());
    ...
    if ((o1 == 0) && onSegment(this->getP1(), this->getP2(), line.getP1())) return true; 
  
    // p1, q1 and q2 are colinear and q2 lies on segment p1q1 
    if ((o2 == 0) && onSegment(this->getP1(), this->getP2(), line.getP2())) return true; 
  
    // p2, q2 and p1 are colinear and p1 lies on segment p2q2 
    if ((o3 == 0) && onSegment(line.getP1(), line.getP2(), this->getP1())) return true; 
  
     // p2, q2 and q1 are colinear and q1 lies on segment p2q2 
    if ((o4 == 0) && onSegment(line.getP1(), line.getP2(), this->getP2())) return true; 
